<nav x-data="{ open: false }">
    ...
    <!-- Mobile Navigation Menu (opens when hamburger is clicked) -->
    <div x-show="open" x-transition class="sm:hidden" @click.away="open = false">
        <div class="pt-2 pb-3 space-y-1">
            <a href="" class="block pl-3 pr-4 py-2 text-base font-medium text-gray-700 dark:text-gray-300 hover:text-[#E84400] dark:hover:text-[#E84400] hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                Викторины
            </a>
            <a href="" class="block pl-3 pr-4 py-2 text-base font-medium text-gray-700 dark:text-gray-300 hover:text-[#E84400] dark:hover:text-[#E84400] hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                Рейтинги
